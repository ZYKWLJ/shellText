...
def pdf_to_h_files(pdf_path, output_dir, max_pages):
    ...
    for page_num, image in enumerate(images, start=1):
        ...
        header_content = f'#ifndef PAGE_{page_num}_H\n#define PAGE_{page_num}_H\n#define PAGE_{page_num} \\\n"{content}"\n#endif'

        # 生成输出文件路径
        output_path = os.path.join(output_dir, f'page{page_num}.h')
...
if __name__ == "__main__":
    pdf_path = '/home/eyk/文档/xwechat_files/wxid_4qgi1qtrnr6w22_553c/msg/file/2025-04/前300页面.pdf'
    output_dir = '/home/eyk/1code/shellText/shellText/2.beta/python_page/pages'
    max_pages = 300  # 可根据需要修改为其他页数
